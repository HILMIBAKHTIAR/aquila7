...
// echo $_POST['fields'];
$host = json_decode($_POST['server'], true);
...
$query = mysqli_query($con, $conn, $sql) or die("ajax-grid-data.php: get Total Filtered Data");
...
if( !empty($requestData['search']['value']) ) {
    ...
    $sql .= " )";
    // echo $sql;exit();
    $query=mysqli_query($con, $conn, $sql) or die("ajax-grid-data.php: get Data With Search");
    ...
    $query=mysqli_query($con, $conn, $sql) or die("ajax-grid-data.php: get Data With Search"); // again run query with limit
    ...
    $sql .= " LIMIT ".$requestData['start']." ,".$requestData['length']."   ";
    // echo $sql;exit();
    $query=mysqli_query($con, $conn, $sql) or die("ajax-grid-data.php: get Data Without Search");
}
